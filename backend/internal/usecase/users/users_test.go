...
import (
	...
	entity "github.com/AvitoTeam49/ScamTrainer/backend/internal/domain/users"
	"github.com/AvitoTeam49/ScamTrainer/backend/internal/usecase/users/mocks"
...
func TestUserService_CreateUser_Success_Gomock(t *testing.T) {
	...
	// Act
	user, err := srv.CreateUser(context.Background(), userID, username)
