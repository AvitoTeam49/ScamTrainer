...
func (r *postgresRepository) CreateUser(ctx context.Context, userID int64, username string) (*entity.User, error) {
	u, err := r.queries.CreateUser(ctx, sqlcUsers.CreateUserParams{
		ID:       userID,
		Username: username,
	})
	if err != nil {
